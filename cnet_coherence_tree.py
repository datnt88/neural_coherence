...
if __name__ == '__main__':
    ...
    X_train_1, X_train_0 = cnet_helper.load_data_by_tree("final_data/CNET/x_cnet.train", 
    ...
    X_dev_1, X_dev_0 = cnet_helper.load_data_by_tree("final_data/CNET/x_cnet.dev", 
            perm_num = opts.p_num, maxlen=opts.maxlen, w_size=opts.w_size, vocabs=vocabs, emb_size=opts.emb_size, fn=fn)
    print("loading dev data done...")

    X_test_1, X_test_0  = cnet_helper.load_data_by_tree("final_data/CNET/x_cnet.test", 
