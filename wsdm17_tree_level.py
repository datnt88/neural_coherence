...
if __name__ == '__main__':
    ...
    X_train_1, X_train_0, train_dist = cnet_helper.load_tree_pairs("final_data/CNET/p5_s_cnet.X", 
            perm_num = opts.p_num, maxlen=opts.maxlen, window_size=opts.w_size, vocab_list=vocabs, emb_size=opts.emb_size, fn=fn)

    X_dev_1, X_dev_0, dev_dist    = cnet_helper.load_tree_pairs("final_data/CNET/p5_s_cnet.X", 
            perm_num = opts.p_num, maxlen=opts.maxlen, window_size=opts.w_size, vocab_list=vocabs, emb_size=opts.emb_size, fn=fn)

    X_test_1, X_test_0, test_dist    = cnet_helper.load_tree_pairs("final_data/CNET/p5_s_cnet.X", 
