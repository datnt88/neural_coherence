...
if __name__ == '__main__':
    ...
    X_train_1, X_train_0, E = email_helper.load_task_X("final_data/CNET/p5_s_cnet.train_tmp", 
            perm_num = opts.p_num, maxlen=opts.maxlen, window_size=opts.w_size, vocab_list=vocab, emb_size=opts.emb_size, fn=fn)

    X_dev_1, X_dev_0, E    = email_helper.load_task_X("final_data/CNET/p5_s_cnet.dev_tmp", 
            perm_num = opts.p_num, maxlen=opts.maxlen, window_size=opts.w_size, vocab_list=vocab, emb_size=opts.emb_size, fn=fn)

    X_test_1, X_test_0, E    = email_helper.load_task_X("final_data/CNET/p5_s_cnet.test_tmp", 
