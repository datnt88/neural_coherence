...
def insert(filename="", k = 0, w_size=3, maxlen=14000, vocabs=None, feats=None):
    ...
    X_1 =  cnet_helper.load_temporal_POS_EGrid(filename=filename, w_size=w_size, maxlen=maxlen , vocabs=vocabs, feats=fn )
    ...
    for pos in range(0,doc_size):
        ...
        X_0 =  cnet_helper.load_temporal_NEG_EGrid(filename=filename, w_size=w_size , maxlen=maxlen , vocabs=vocabs, feats=fn, perm=perm)
        #print(perm)
